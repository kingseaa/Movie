    ...
    def recommend2(self, u):
        ...
        for i in range(self.n_items):
            if i not in items_rated_by_u:
                ...
                if rating > 0:
                    #recommended_items.append(i)
                    recommended_items.append([rating,i])
...
def process_request():
    ...
    print(f"Received Request ID: {user_id}")
    dataRecommend = loaded_model.recommend(user_id)
    print(dataRecommend)
  
    return jsonify(dataRecommend)
