...
const OpenMovie = () => {
  return (
    <div className="w-full relative bg-black overflow-hidden flex flex-col items-end justify-start tracking-[normal]">
      <section className="self-stretch flex flex-col items-center justify-start gap-[218px] bg-[url('/public/hero@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full shrink-0 mq750:gap-[218px] mq450:gap-[218px]">
        <HeaderDetail />
        <MovieInfo />
      </section>
      <Video />
