            ...
            <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                >
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <h2 className="text-lg font-bold pt-8 lg:pt-0 text-red-500">Edit Profile</h2>
                        <p className="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">
                            ...
                            <div class="md:w-2/3">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" value="" placeholder="Name"/>
                            </div>
                        </p>
                        <p className="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">
                            <i className="fa-solid fa-user h-4 fill-current text-green-700 pr-4"></i>
                            <div class="md:w-2/3">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="date" value="" placeholder="Name"/>
                            </div>
                        </p>
                        <p className="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">
                        ...
                        <p className="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">
                            ...
                            <div class="md:w-2/3">
                                <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" value="" placeholder="Phone"/>
                            </div>
                        </p>
