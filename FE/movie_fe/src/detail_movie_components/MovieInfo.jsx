  ...
  return (
    <div className="self-stretch flex flex-row items-end justify-between py-16 px-[75px] box-border gap-[20px] max-w-full text-left text-13xl text-white font-rubik lg:flex-wrap lg:pl-[37px] lg:pr-[37px] lg:box-border">
      <div className="w-[506px] flex flex-col items-start justify-start gap-[24px] min-w-[506px] max-w-full lg:flex-1 mq750:min-w-full">
        <button className="cursor-pointer [border:none] py-1 px-4 bg-black rounded-2xl flex flex-row items-center justify-center hover:bg-darkslategray">
          <div className="relative text-xs tracking-[0.01em] leading-[20px] font-medium font-rubik text-grayscale-grayscale-10 text-left">
            Series
          </div>
        </button>
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
          <h1 className="m-0 self-stretch relative text-inherit tracking-[0.01em] leading-[40px] font-bold font-inherit mq1050:text-7xl mq1050:leading-[32px] mq450:text-lgi mq450:leading-[24px]">
            The Last Of Us Season 1
          </h1>
          <div className="self-stretch relative text-sm tracking-[0.01em] leading-[22px] text-grayscale-grayscale-60">
